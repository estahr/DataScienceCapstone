...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, 
                     values='class', 
                     names="Launch Site", 
                     title='Proportion of Successes by Site')
    else:
        ...
        fig = px.pie(filtered_df, 
            ...
            title = "Proportion of successes at " + entered_site)
    return fig
...
def get_scatter_plot(entered_site, payload):
    ...
    if entered_site == 'ALL':
        ...
        success_value = filtered_df.index.map({1: "Success", 0: "Failure"})
...
#change port to 8124 to solve errors
def run_server(self,
               port=8050,
               debug=True,
               threaded=True,
